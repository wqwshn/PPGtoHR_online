 ...
 * ============================================================
 * 由 MATLAB butter(4, [0.5, 5]/(125/2), 'bandpass') 计算.
 * 4 阶带通滤波器 = 4 个 biquad 节级联.
 * 每节格式: [b0, b1, b2, -a1, -a2] (CMSIS-DSP biquad 格式).
 *
 * MATLAB 输出 (SOS 格式, 增益 g = 0.00012376):
 *   节1: [1.0, 2.0, 1.0, 1, -1.65549007, 0.69240918]
 *   节2: [1.0, 2.0, 1.0, 1, -1.79984960, 0.85580644]
 *   节3: [1.0, -2.0, 1.0, 1, -1.94757681, 0.94846728]
 *   节4: [1.0, -2.0, 1.0, 1, -1.98311826, 0.98377144]
 * 增益均匀分配到 4 节: g^(1/4) = 0.094168
 */
const float HR_BPF_COEFFS[20] = {
    /* 第 1 节: [b0, b1, b2, -a1, -a2] */
    0.094168f,   0.188336f,   0.094168f,   1.65549007f, -0.69240918f,
    /* 第 2 节: [b0, b1, b2, -a1, -a2] */
    0.094168f,   0.188336f,   0.094168f,   1.79984960f, -0.85580644f,
    /* 第 3 节: [b0, b1, b2, -a1, -a2] */
    0.094168f,  -0.188336f,   0.094168f,   1.94757681f, -0.94846728f,
    /* 第 4 节: [b0, b1, b2, -a1, -a2] */
    0.094168f,  -0.188336f,   0.094168f,   1.98311826f, -0.98377144f
};
